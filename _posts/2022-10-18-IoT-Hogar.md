...
![Device](assets/imagenes/esp8266_foto.jpg)
...
![emqx](assets/imagenes/25_dashboard_datos2.png)
**Dashboard con datos del dispositivo**
...
## [](header-3) NodeJS
NodeJS es un entorno de ejecución para JavaScript construido con el motor de JavaScript V8. Este servicio nos vendrá muy bien para poder recibir la información de broker y guardarla en la base de datos MySQL en tiempo real.
En primer lugar necesitamos instalar **node** y su gestor de paquetería **npm**.
...
# [Ataque](header-2) Ataque
## [Ataque](header-3) Recopilación de información
...
![ataque](assets/imagenes/xss1.png)
*Agregar dispositivos*

![ataque](assets/imagenes/xss2.png)
*Vulnerable a XSS*
...
## [Ataque](header-3) Secuestro de cookie de administrador
...
![ataque](assets/imagenes/apache_ports.png)
*Configuración ports.conf*

![ataque](assets/imagenes/apache_default.png)
*Configuración 000-defaults.conf*
...
![ataque](assets/imagenes/editthiscookie.png)
...
![ataque](assets/imagenes/listado_disp.png)
...
![ataque](assets/imagenes/edicion_campo.png)
...
## [Ataque](header-3) Registro de dispositivos maliciosos
